...
const Modal = () => {
    const [showModel, setShowState] = useRecoilState(modalState);
    ...
    return (
        <MuiModal open={showModel} onClose={handleClose}
            className="fixed !top7 left-0 right-0 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md"
        >
            <>
                <button className=" modalButton h-9 w-9 cursor-pointer !z-40 absolute top-5 right-5 bg-[#181818] border-none hover:bg-[#181818] transition hover:scale-125" onClick={handleClose}>
